 ...
 *
 */
public class CirculateOrder implements Serializable {

	private static final long serialVersionUID = 2511840660713595958L;
	
	private String title = "";                     // 标题
    private String barCode = "";                   // 条形码
    private String sendLocation = "";             // 发货地点
    private String receiveLocation = "";          // 收货地点
    private String transactionType = "";          // 交易类型
    private String consignorOrgId = "";

    private String wsSendFlag = "";                // 车间
    private String wsSendCode = "";                // 道口代码
